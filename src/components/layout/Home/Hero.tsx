...
export function Hero() {
  ...
  return (
    <section className="bg-[#4B203A] text-white py-16 sm:py-20 px-4 sm:px-6 md:px-12 lg:px-20 relative">
      {/* Main Container */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6">
            Revolutionizing{" "}
            <span className="text-[#C8B491]">Lending</span>
            <br />
        ...
        >
          ...
          />
          {
             creditScore ?  <div className="absolute bottom-3 right-1 md:bottom-4 md:-right-16 bg-white text-xs sm:text-sm text-black px-3 sm:px-4 py-2 rounded shadow">
      ...
      <motion.div
        ...
        className="bg-white text-black shadow-lg mt-12 sm:mt-16 rounded-lg py-6 sm:py-8 px-4 sm:px-6 md:px-12 max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center"
      >
        <div>
